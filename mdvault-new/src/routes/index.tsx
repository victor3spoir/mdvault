	...
	return (
		<main className="relative isolate flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-background px-4 py-8 text-center">
			...
			<div className="container relative z-20 mx-auto flex h-full max-w-4xl flex-col items-center justify-center gap-4">
				...
				<div className="animate-in fade-in mt-6 hidden w-full gap-6 duration-1000 delay-700 lg:flex">
					{features.map((feature) => (
						<div
							key={feature.text}
							className="group flex flex-1 flex-col items-center gap-2 rounded-lg p-2 transition-all duration-300 hover:bg-muted/20"
						>
							<div className="flex h-10 w-10 items-center justify-center rounded-lg bg-linear-to-br from-primary/20 to-accent/10 text-primary">
