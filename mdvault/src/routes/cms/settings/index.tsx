...
import { AssetTypesSettings } from "#/features/vault/components/asset-types-settings";
						...
						<div className="rounded-xl border bg-card">
							...
							<div className="space-y-4 bg-muted/30 p-6">
								...
								<p className="text-xs text-muted-foreground">
									Repository configuration is set through environment variables
						...
						<div className="rounded-xl border bg-card">
							...
							<div className="space-y-4 bg-muted/30 p-6">
								...
								<div className="flex items-start gap-2">
									...
									<p className="text-xs text-muted-foreground">
										Token is stored securely in environment variables. No
										changes can be made through the UI.
									</p>
								</div>
							</div>
						</div>
