...
const highlights = [
	{ icon: IconWriting, text: "Rich Editor" },
	{ icon: IconStack2, text: "Custom Types" },
...
function LandingPage() {
	return (
		<main className="relative isolate flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-background px-4 py-8 text-center">
			...
			<div className="container relative z-20 mx-auto flex max-w-4xl flex-col items-center justify-center gap-4">
