---
title: Documentation
description: GitHub-powered Markdown content management — the repository is the database.
---

MDVault is a content management interface for Markdown that keeps everything in
a GitHub repository you own: the text, its frontmatter, and every image it
